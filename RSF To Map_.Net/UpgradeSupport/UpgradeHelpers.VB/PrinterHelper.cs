// *************************************************************************************
// <copyright file="PrinterHelper.cs" company="Mobilize.Net">
...
//       use at own risk.
// </copyright>
// <summary>Class to emulate the VB6 object printer.</summary>
// *************************************************************************************
...
#pragma warning  disable 1591
    ...
    public class PrinterHelper : IDisposable
    {
        ...
        //1 twip = 1/20 point, 1 point = 1/72 inches --> 1 twip = 1/1440 inches
        //1 inch = 25.4 millimeters -->  1 twip = ((1/1440) * 25.4) millimeters
        private const double MillimetersPerTwip = 0.01763888888888888888888888888889d;
        ...
        /// <summary>
        /// Indicates whether a new page was added or not
        /// </summary>
        private bool NewEmptyPageAdded { get; set; }
        ...
        public float ScaleX(float width, int fromScale, int toScale)
        {
            ...
            else if (fromScale == (int)ScaleModeConstants.VbPixels &&
                toScale == (int)ScaleModeConstants.VbTwips)
            {
                return ConvertFromPixelsToTwipsX(width);
            }
            else if (fromScale == (int)ScaleModeConstants.VbTwips &&
              toScale == (int)ScaleModeConstants.VbMilimeters)
            {
                return (float) ConvertFromTwipsToMillimeters(width);
            }
            else
            {
        ...
        public float ScaleY(float height, int fromScale, int toScale)
        {
                ...
                toScale == (int)ScaleModeConstants.VbTwips)
            {
              ...
              toScale == (int)ScaleModeConstants.VbMilimeters)
            {
                return (float) ConvertFromTwipsToMillimeters(height);
            }
            else
            {
                throw new NotImplementedException(string.Format("Conversion from {0} to {1} not implemented", fromScale, toScale));
        ...
        /// <summary>
        /// Converts From twips to millimeters
        /// </summary>
        /// <param name="twipsValue"></param>
        /// <returns></returns>
        private double ConvertFromTwipsToMillimeters(float twipsValue)
        {
            return twipsValue * MillimetersPerTwip;
        }
        ...
        public void EndDoc()
        {
            ...
            try
            {
                if (HasSomethingToPrint() || this.NewEmptyPageAdded)
                {
                    SendPageToPrint();
                    this.NewEmptyPageAdded = false;
                }
            }
            finally
            {
                ...
                ResetBufferPage();
                ResetPrintingLocation();
            }
        }

        /// <summary>
        /// True, if has something to print. This is true, if bufferPage has data or bufferpage has images to print. Otherwise false
        /// </summary>
        /// <returns></returns>
        private bool HasSomethingToPrint()
        {
            return this._bufferPage.Data != null || this._bufferPage.Images != null || this._bufferPage.Lines != null || this._bufferPage.Rectangles != null || this._bufferPage.Circles != null;
        }
        ...
        {
            PaintPicture(picture, (float) p.X, (float) p.Y);
        }

        /// <summary>
        /// Point is given in the unit specified by Scalemode
        /// </summary>
        public void PaintPicture(Image picture, float x, float y)
        {
            //point is stored in pixels
            PointF newP = new PointF(ConvertToPrinterUnitsX(x), ConvertToPrinterUnitsY(y));
            InternalPaintPicture(picture, newP, SizeF.Empty);
        }

        /// <summary>
        /// Paint a picture in the current page. Points given in the unit specified by Scalemode.
        /// </summary>
        ...
        /// <summary>
        /// Paint a picture in the current page, point and size given in the unit specified by Scalemode.
        /// </summary>
        /// <param name="picture">Picture reference</param>
        /// <param name="x">X position in the paper</param>
        /// <param name="y">Y position in the paper</param>
        /// <param name="width">Width of the image to be drawn in the paper</param>
        /// <param name="height">Height of the image to be drawn in the paper</param>
        public void PaintPicture(Image picture, float x, float y, float width, float height)
        {
            PointF newP = new PointF(ConvertToPrinterUnitsX(x), ConvertToPrinterUnitsY(y));
            SizeF newSize = new SizeF(ConvertToPrinterUnitsX(width), ConvertToPrinterUnitsY(height));
            InternalPaintPicture(picture, newP, newSize);
        }

        /// <summary>
        ///   Paints a picture in the current page. Parameters given in the unit specified by Scalemode.
        /// </summary>
        /// <param name="picture">Picture reference</param>
        ...
        {
            InternalPaintPicture(picture,
                         new PointF(ConvertToPrinterUnitsX(x1), ConvertToPrinterUnitsY(y1)),
                         new SizeF(ConvertToPrinterUnitsX(w1), ConvertToPrinterUnitsY(h1)),
                         new RectangleF(ConvertToPrinterUnitsX(x2), ConvertToPrinterUnitsY(y2), ConvertToPrinterUnitsX(w2), ConvertToPrinterUnitsY(h2)));
        }

        /// <summary>
        /// This method starts the printer thread adds a new to the image buffer.
        /// </summary>
        /// <param name="picture">The picture to be printed</param>
        /// <param name="point">The start point to draw the image</param>
        /// <param name="size">The size the image</param>
        ...
        /// <summary>
        /// This method starts the printer thread adds a new to the image buffer.
        /// Additionally resizes the image to the giving clipping info
        /// </summary>
        /// <param name="picture">The picture to be printer</param>
        /// <param name="point">The start point to draw the image</param>
        /// <param name="size">The size the image</param>
        private void InternalPaintPicture(Image picture, PointF point, SizeF size, RectangleF clippingInfo)
        {
            InternalPaintPicture(picture, point, size);

            ImageInfo newImageInformation = _bufferPage.Images[_bufferPage.Images.Count - 1];
            newImageInformation.hasClippingInfo = true;
            newImageInformation.clippingInfo = clippingInfo;
        ...
        public void NewPage()
        {
            try
            {
                if (_bufferPage.Data == null)
                {
                    PrinterHelper.Printer.Print("");
                    this.NewEmptyPageAdded = true;
                }
        ...
        {
            SizeF size = PrinterGraphics.MeasureString(str, Font, int.MaxValue, StringFormat.GenericTypographic);
        ...
        /// <summary>
        /// Reset Printing Location
        /// </summary>
        private void ResetPrintingLocation()
        {
            _currentX = 0;
            _currentY = 0;
        }
                        ...
                        using (SolidBrush brush = new SolidBrush(Color.Black))
                        {
                            for (int i = 0; i < _bufferPage.Data.Count; i++)
                            {
                                ...
                                e.Graphics.DrawString(_bufferPage.Data[i].Value,
                                       ...
                                       (float)ConvertFromPixelsY(_bufferPage.Data[i].Y, scaleMode), StringFormat.GenericTypographic);
                            }
                        }
                    }
                }
 ...
 */
        ...
        public void KillDoc()
        {
            ...
            this.ResetPageConfiguration();
            this.ResetBufferPage();
        }

        /// <summary>
        /// Reset Printing job
        /// </summary>
        private void ResetPageConfiguration()
        {
        ...
        #endregion Nested type: DataInfo
        ...
        #endregion Nested type: DrawModeConstants
        ...
        #endregion Nested type: FillStyleConstants
        ...
        #endregion Nested type: ImageInfo
        ...
        #endregion Nested type: LineInfo
        ...
        #endregion Nested type: PageInfo
        ...
        #endregion Nested type: PrinterObjectConstants
        ...
        #endregion Nested type: RectangleInfo
        ...
        #endregion Nested type: ScaleModeConstants
