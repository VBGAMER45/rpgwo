...
Dim TagNum As Integer
    For i = 0 To 43
        ...
        If TagNum < UBound(Items) Then
            BitBlt picItem(i).hdc, 0, 0, 32, 32, pbxMonster(MonsterSelect(TagNum).ImageFile).ImageDC, MonsterSelect(TagNum).TileX, MonsterSelect(TagNum).TileY, SRCCOPY
        End If
    Next i
End Sub
...
Private Sub SelectLoadNumber()
    ...
    If optLevel11 = True Then
        Call LoadMonstersByClass(11, 20)
    End If
    If optLevel21 = True Then
        Call LoadMonstersByClass(21, 30)
    End If
    If optLevel31 = True Then
        Call LoadMonstersByClass(31, 40)
    End If
    If optLevel41 = True Then
        Call LoadMonstersByClass(41, 50)
    End If
    If optLevel51 = True Then
        Call LoadMonstersByClass(51, 60)
    End If
    If optLevel61 = True Then
        Call LoadMonstersByClass(61, 70)
    End If
    If optLevel71 = True Then
        Call LoadMonstersByClass(71, 9999)
    End If
    If OptTrade = True Then
        Call LoadMonstersByClass(12, 12)
    End If
