...
Begin VB.Form frmWeaponSelect 
   ...
   End
End
Attribute VB_Name = "frmWeaponSelect"
...
On Error Resume Next
    ...
    iItemID = ItemSelect(picItem(Index).Tag).ItemId
   If Items(iItemID).MissileWeapon = True Then
        frmClient.txtMissileMax.Text = Items(iItemID).DamageHigh
        MisMax = Items(iItemID).DamageHigh
        MisRange = Items(iItemID).WeaponMaxRange
        frmClient.txtMissileWeaponRange.Text = Items(iItemID).WeaponMaxRange
        MisMin = Items(iItemID).DamageLow
        frmClient.txtMissileMin.Text = Items(iItemID).DamageLow
        WeaponMin = 0
        frmClient.txtMeleeMin.Text = 0
        WeaponMax = 0
        frmClient.txtMeleeMax.Text = 0
        WandPower = 0
        frmClient.txtWandPower.Text = 0
   Else
      MisRange = 0
      MisMax = 0
      MisMin = 0
      frmClient.txtMissileWeaponRange.Text = 0
      frmClient.txtMissileMin.Text = 0
      frmClient.txtMissileMax.Text = 0
      If Items(iItemID).MagicPower = 0 Then
        WeaponMin = Items(iItemID).DamageLow
        frmClient.txtMeleeMin.Text = Items(iItemID).DamageLow
        WeaponMax = Items(iItemID).DamageHigh
        frmClient.txtMeleeMax.Text = Items(iItemID).DamageHigh
        WandPower = 0
        frmClient.txtWandPower.Text = 0
      Else
      'IS wand
        ...
        WeaponMax = 0
        frmClient.txtMeleeMax.Text = 0
        WandPower = Items(iItemID).MagicPower
        frmClient.txtWandPower.Text = Items(iItemID).MagicPower
      End If
