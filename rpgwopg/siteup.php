...
/*
//@$fp = fsockopen ("66.36.229.88",6015, $errno, $errstr, 1);
if (!$fp) {
...
//@$fp2 = fsockopen ("66.139.77.89",6016, $errno, $errstr, 1);
if (!$fp2) {
//server doesn't exist
...
//@$fp3 = fsockopen ("66.36.229.88",6016, $errno, $errstr, 1);
if (!$fp3) {
//server doesn't exist
...
//@$fp4 = fsockopen ("66.139.77.89",6015, $errno, $errstr, 1);
if (!$fp4) {
//server doesn't exist
print("Arcanium Server is down!<BR>");
}
else
{
//server does exst
print("Arcanium Server is up!<BR>");

}

//@$fp5 = fsockopen ("66.36.229.88",6017, $errno, $errstr, 1);
if (!$fp5) {
//server doesn't exist
print("Mission World is down!<BR>");
}
else
{
//server does exst
print("Misson World is up!<BR>");
