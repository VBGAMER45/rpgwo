...
<HTML>
   <HEAD>
     ...
     <TITLE>RPGWO-PG: SteelTide</TITLE>
   </HEAD>
...
<!-- END MENU CODE -->
        ...
        <td width="520" height="25"  style="background-color: #0080FF">
          <p align="center"><font style="font-weight: bold">The World of SteelTide</font></p>
        </td>
      </tr>
      <tr>
	...
	<p>SteelTide is a server that is best for newbies to Rpgwo</p>
	<p>SteelTide has seiges, quests, and the abilty to be non pk</p>
	<p>Items on your land can not be stolen</p>
	<p>The world is twice as big as Phobos</p>
	<p>But there are more rules to follow in that world such as no spawn killing</p>
