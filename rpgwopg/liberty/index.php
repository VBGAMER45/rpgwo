...
<!-- END MENU CODE -->
        ...
        <td width="520" height="25"  style="background-color: #0080FF">
          <p align="center"><font style="font-weight: bold">The World of Liberty</font></p>
        </td>
      </tr>
      <tr>
	...
	<p>Liberty is a server that is best for newbies to Rpgwo</p>
	<p>Liberty has seiges, quests, and the abilty to be non pk</p>
