...
include($root_path . "header.php");
	...
	If(verifysession($s))
	{
		...
		if(@$B1=="Edit Guild")
		{
			...
			if(@$leader=="")
			{
				print("You need to a guild leader!");
				exit();
			}
		...
		$Result = site_query("SELECT Username, ID FROM guildpost", $dblink);
			if (!$Result) {
		...
		$sql = "Update guildpost SET
  		...
  		if (@site_query($sql)) {
    			echo("<p>Your guild has been Updated!</p>");
 		 }
		else {
    				echo("<p>Error updating guild :" . mysqli_error() . "</p>");
  			}
...
<HTML>
   <HEAD>
	...
	<base href="http://www.projectxonline.net/rpgwo/">
     ...
     <TITLE>RPGWO-PG: Edit Guild  </TITLE>
   </HEAD>
...
<!-- END MENU CODE -->
        ...
        <td width="520" height="25"  style="background-color: #0080FF">
          <p align="center"><font style="font-weight: bold">Edit Guild</font></p>
        </td>
      </tr>
      <tr>
...
<form action=guilds/editguild.php method="POST">
  <center>
  ...
  <p><input type="submit" value="Edit Guild" name="B1"></p>
