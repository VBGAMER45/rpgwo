...
if(@$B1=="Add Loan")
{
	...
	if(@$loan=="")
	{
		print("<b>You need to enter a Loan Amount</b>");
		exit();
	}
	if(@$loan <= 0)
	{
		print("<b>Loan has to be greater than zero</b>");
		exit();
	}
