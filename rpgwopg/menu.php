...
<a style='margin-left: 8' href='./index.<? print("php?server=$server&s=$s"); ?>'>RPGWO-PG</a><br>
<?php
...
?>
<a style='margin-left: 16' href='./News.<? print("php?server=$server&s=$s"); ?>'>News</a><br>
<a style='margin-left: 16' href='./The_Basics.<? print("php?server=$server&s=$s"); ?>'>The Basics</a><br>
<a style='margin-left: 16' href='./artwork/'>Artwork for Rpgwo</a><br>
...
print("<a style='margin-left: 16' href='./SteelTide/index.php?server=5&s=$s'>SteelTide</a><br>");
...
if($server==5)
{
   ...
   print("<a style='margin-left: 24' href='./servernews.php?server=$server&s=$s'>World News</a><br>");
   print("<a style='margin-left: 24' href='./poi/index2.php?server=$server&s=$s'>Points of Interest</a><br>");
   print("<a style='margin-left: 24' href='./phorum/index.php?server=$server&s=$s'> SteelTide Forum</a><br>");
   print("<a style='margin-left: 24' href='./guilds.php?server=$server&s=$s'>Guilds</a><br>");
   print("<a style='margin-left: 24' href='./shops.php?server=$server&s=$s'>Player's Shops</a><br>");
   print("<a style='margin-left: 24' href='./wanted.php?server=$server&s=$s'>Wanted List</a><br>");

}
print("<a style='margin-left: 16' href='./UTWorld/index.php?server=4&s=$s'>Acanium</a><br>");
...
if($server==4)
{
   ...
   print("<a style='margin-left: 24' href='./servernews.php?server=$server&s=$s'>World News</a><br>");
   print("<a style='margin-left: 24' href='./poi/index2.php?server=$server&s=$s'>Points of Interest</a><br>");
   print("<a style='margin-left: 24' href='./phorum/index.php?server=$server&s=$s'> UT World Forum</a><br>");
   print("<a style='margin-left: 24' href='./guilds.php?server=$server&s=$s'>Guilds</a><br>");
   print("<a style='margin-left: 24' href='./shops.php?server=$server&s=$s'>Player's Shops</a><br>");
   print("<a style='margin-left: 24' href='./wanted.php?server=$server&s=$s'>Wanted List</a><br>");
...
<a style='margin-left: 16' href='./monsterlist/monsterlist.php?page=0'>Monster List</a><br>
<a style='margin-left: 16' href='./itemlist/index.<? print("php?server=$server&s=$s"); ?>'>Item List</a><br>
<a style='margin-left: 16' href='./screen.<? print("php?server=$server&s=$s"); ?>'>ScreenShots</a><br>
<a style='margin-left: 16' href='./Downloads.<? print("php?server=$server&s=$s"); ?>'>Downloads</a><br>
<a style='margin-left: 16' href='https://rpgwoforums.net/'>Forum</a><br>

<a style='margin-left: 16' href='./FAQ.<? print("php?server=$server&s=$s"); ?>'>FAQ</a><br>
<a style='margin-left: 16' href='./reviews/index.<? print("php?server=$server&s=$s"); ?>'>Reviews</a><br>
<a style='margin-left: 16' href='./online.<? print("php?server=$server&s=$s"); ?>'>Whos Online Rpgwo</a><br>
<a style='margin-left: 16' href='./links.<? print("php?server=$server&s=$s"); ?>'>Links</a><br>
<a style='margin-left: 16' href='./Contact.<? print("php?server=$server&s=$s"); ?>'>Contact</a><br>
