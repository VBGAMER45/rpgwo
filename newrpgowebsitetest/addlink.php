...
if(!mysql_select_db($dbname))
{
	...
	exit();
		...
		$sql = "INSERT INTO linkpost SET 
  		...
  		if (@mysql_query($sql)) { 
    			echo("<p>Your link post has been added</p>"); 
 		 }		
	 else { 
    			echo("<p>Error adding link post :" . mysql_error() . "</p>"); 
  		} 
}
?>
<HTML>
<HEAD>
	...
	<title>RPG World Online - Add Link</title>
...
<form method="POST" action="addlink.php">
  ...
  <p><b>Link Title <input type="text" name="title" size="27"></b></p>
  <p><b>Link Url: Begin with http://<input type="text" name="url" size="27"></b></p>
  <p><b>Description</b></p>
  <p><textarea rows="7" name="Description" cols="42"></textarea></p>
  <p><input type="submit" value="Add Link" name="submit"></p>
</form>
