...
if(!mysql_select_db($dbname))
{
	...
	exit();
		...
		$ID=addslashes($ID);
		$sql = "Delete FROM faqpost
			WHERE ID='$ID'";


  		if (@mysql_query($sql)) { 
    			echo("<p>Your faqpost has been deleted!</p>");
			exit(); 
 		 }		
		else { 
    				echo("<p>Error deleting faqpost:" . mysql_error() . "</p>"); 
  			} 		
}
...
<HEAD>
	...
	<title>RPG World Online - Delete Faq</title>
