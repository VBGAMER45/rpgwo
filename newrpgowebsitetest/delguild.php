...
if(!mysql_select_db($dbname))
{
	...
	exit();
		...
		$sql = "Delete FROM guildpost
  		...
  		if (@mysql_query($sql)) { 
    			echo("<p>Your guildpost has been deleted!</p>");
			exit(); 
 		 }		
		else { 
    				echo("<p>Error deleting guildpost:" . mysql_error() . "</p>"); 
  			} 		
}
...
<HEAD>
	...
	<title>RPG World Online - Delete Guild</title>
